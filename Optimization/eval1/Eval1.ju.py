...
# %%
x0 = np.zeros(pb1.d)
x1, xjfjsfjsfjz_tab = CG_quadratic(pb1.A, pb1.b, pb1.f, pb1.grad_f, x0,
                                   iterMax=10000, prec=1e-10, restarts=2:q
...
jqq:q,q q q q q qq q q q qq q q#
